...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Thomas Vidic';
    var email  = 'theuklid@gmail.com';
    ...
    if (!newname) {
        console.log('Please write the new viessmannapi name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/viessmannapi.png')) {
        fs.renameSync(__dirname + '/admin/viessmannapi.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/viessmannapi.html')) {
        fs.renameSync(__dirname + '/widgets/viessmannapi.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/viessmannapi/js/viessmannapi.js')) {
        fs.renameSync(__dirname + '/widgets/viessmannapi/js/viessmannapi.js', __dirname + '/widgets/viessmannapi/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/viessmannapi')) {
        fs.renameSync(__dirname + '/widgets/viessmannapi',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /viessmannapi/g,
            replacement: newname
        },
        {
            match: /viessmannapi/g,
        ...
        {
            match: /Viessmannapi/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Viessmannapi'
        },
        {
            match: /Thomas Vidic/g,
            replacement: author
        },
        {
            match: /theuklid@gmail.com/g,
            replacement: email
        }
    ];
    var files = [
